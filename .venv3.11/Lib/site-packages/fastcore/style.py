...
# %% ../nbs/08_style.ipynb #73c4d89c
S = Style()

# %% ../nbs/08_style.ipynb #7c016111
def _demo(name, code):
    s = getattr(S,name)
    print(s(f'{code.code:>3}    {name:16}'))

# %% ../nbs/08_style.ipynb #cf21a9bd
def demo():
